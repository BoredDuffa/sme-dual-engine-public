# IC Draft: A & D; ADVERTISING AND DESIGN CONSULTANTS LIMITED (CRO 234849)

**Diligence status:** watchlist

## Company Overview

- Name: A & D; ADVERTISING AND DESIGN CONSULTANTS LIMITED
...
- `company_age_years` from cro_open_services (observed, confidence 1.0): 30.0
...
- `source_key` from cro_open_services (observed, confidence 1.0): 234849
