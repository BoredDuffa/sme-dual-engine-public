# IC Draft: A.P. MCCARTHY PLANNING CONSULTANTS LIMITED (CRO 328511)

**Diligence status:** watchlist

## Company Overview

- Name: A.P. MCCARTHY PLANNING CONSULTANTS LIMITED
- Location: Block 1, Galway
...
- `company_age_years` from cro_open_services (observed, confidence 1.0): 25.0
...
- `source_key` from cro_open_services (observed, confidence 1.0): 328511
