# IC Draft: Agricultural Inputs and Supplements Provider

**Diligence status:** watchlist

## Company Overview

- Name: Agricultural Inputs and Supplements Provider
...
- `name` from business_sale_report (observed, confidence 1.0): Agricultural Inputs and Supplements Provider
- `normalized_name` from business_sale_report (observed, confidence 1.0): agricultural inputs and supplements provider
