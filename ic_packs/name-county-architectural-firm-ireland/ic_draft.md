...
- `name` from business_sale_report (observed, confidence 1.0): Architectural Firm
- `normalized_name` from business_sale_report (observed, confidence 1.0): architectural firm
...
- `source_key` from business_sale_report (observed, confidence 1.0): 03d862fd17b4e704
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/architectural-firm-professional-and-financial-ireland-679685
- `summary` from business_sale_report (observed, confidence 1.0): This established architectural practice in Ireland presents a significant growth opportunity with a strong team already in place and potential for expansion into new areas. Business Sale Report public listing observed 2026-06-24.
