# IC Draft: Award-Winning Beauty Salon

**Diligence status:** enrichment_required

## Company Overview

- Name: Award-Winning Beauty Salon
...
- `name` from business_sale_report (observed, confidence 1.0): Award-Winning Beauty Salon
- `normalized_name` from business_sale_report (observed, confidence 1.0): award winning beauty salon
...
- `source_key` from business_sale_report (observed, confidence 1.0): 2aac86b8e77fd2da
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/award-winning-beauty-salon-services-ireland-680153
- `summary` from business_sale_report (observed, confidence 1.0): This is an exceptional opportunity to acquire a long-established and award-winning beauty salon in a prime Dublin location, known for its professional skincare, beauty, and wellness treatments. Business Sale Report public listing observed 2026-06-24.
