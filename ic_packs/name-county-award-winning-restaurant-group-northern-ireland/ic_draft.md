# IC Draft: Award-Winning Restaurant Group

**Diligence status:** watchlist

## Company Overview

- Name: Award-Winning Restaurant Group
...
- `name` from business_sale_report (observed, confidence 1.0): Award-Winning Restaurant Group
- `normalized_name` from business_sale_report (observed, confidence 1.0): award winning restaurant group
