# IC Draft: B2B Food Distribution

**Diligence status:** enrichment_required

## Company Overview

- Name: B2B Food Distribution
...
- `name` from business_sale_report (observed, confidence 1.0): B2B Food Distribution
- `normalized_name` from business_sale_report (observed, confidence 1.0): b2b food distribution
...
- `source_key` from business_sale_report (observed, confidence 1.0): 72557b20ff570c36
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/b2b-food-distribution-wholesale-ireland-679413
- `summary` from business_sale_report (observed, confidence 1.0): This long-established food distribution company in Kildare boasts a diverse product portfolio, catering to a loyal B2B customer base across deli counters, caterers, independent wholesalers, and food manufacturers. Business Sale Report public listing observed 2026-06-24.
