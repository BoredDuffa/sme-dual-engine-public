# IC Draft: Beauty Salon for Sale in County Meath, Ireland

**Diligence status:** watchlist

## Company Overview

- Name: Beauty Salon for Sale in County Meath, Ireland
- Location: County Meath, Ireland, Meath
...
- `name` from smergers (observed, confidence 1.0): Beauty Salon for Sale in County Meath, Ireland
- `normalized_name` from smergers (observed, confidence 1.0): beauty salon for sale in county meath ireland
- `price_text` from smergers (observed, confidence 1.0): EUR 70 K
- `price_value` from smergers (observed, confidence 1.0): 70000.0
