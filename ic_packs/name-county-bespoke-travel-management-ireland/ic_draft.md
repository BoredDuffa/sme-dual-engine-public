# IC Draft: Bespoke Travel Management

**Diligence status:** watchlist

## Company Overview

- Name: Bespoke Travel Management
...
- `name` from business_sale_report (observed, confidence 1.0): Bespoke Travel Management
- `normalized_name` from business_sale_report (observed, confidence 1.0): bespoke travel management
...
- `source_key` from business_sale_report (observed, confidence 1.0): 8cedb37456a0aa68
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/bespoke-travel-management-leisure-and-lifestyle-ireland-679448
- `summary` from business_sale_report (observed, confidence 1.0): This is a rare opportunity to acquire a well-established travel management business with decades of operational history, strong brand recognition, and a loyal customer base. Business Sale Report public listing observed 2026-06-24.
