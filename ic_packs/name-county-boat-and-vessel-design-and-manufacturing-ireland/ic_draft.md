# IC Draft: Boat and Vessel Design and Manufacturing

**Diligence status:** enrichment_required

## Company Overview

- Name: Boat and Vessel Design and Manufacturing
...
- `name` from business_sale_report (observed, confidence 1.0): Boat and Vessel Design and Manufacturing
- `normalized_name` from business_sale_report (observed, confidence 1.0): boat and vessel design and manufacturing
