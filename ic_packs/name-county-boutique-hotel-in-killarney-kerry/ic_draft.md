# IC Draft: Boutique Hotel in Killarney

**Diligence status:** defer

## Company Overview

- Name: Boutique Hotel in Killarney
...
- `county` from bizbuy_ie (observed, confidence 1.0): Kerry
...
- `name` from bizbuy_ie (observed, confidence 1.0): Boutique Hotel in Killarney
- `normalized_name` from bizbuy_ie (observed, confidence 1.0): boutique hotel in killarney
...
- `source_key` from bizbuy_ie (observed, confidence 1.0): a225d64fee9eedd2
- `source_section` from bizbuy_ie (observed, confidence 1.0): advertised_sale_listings
- `source_url` from bizbuy_ie (observed, confidence 1.0): https://bizbuy.ie/business/6
