# IC Draft: Building Services Engineering Specialist

**Diligence status:** enrichment_required

## Company Overview

- Name: Building Services Engineering Specialist
...
- `name` from business_sale_report (observed, confidence 1.0): Building Services Engineering Specialist
- `normalized_name` from business_sale_report (observed, confidence 1.0): building services engineering specialist
...
- `source_key` from business_sale_report (observed, confidence 1.0): 5519f97aee36821e
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/building-services-engineering-specialist-services-northern-ireland-680348
- `summary` from business_sale_report (observed, confidence 1.0): This Northern Ireland-based business is a remarkable acquisition opportunity thanks to its long-standing reputation, award-winning services, and a robust base of repeat clients across multiple sectors. Business Sale Report public listing observed 2026-06-24.
