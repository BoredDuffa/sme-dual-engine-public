...
- `name` from business_sale_report (observed, confidence 1.0): Business Services
- `normalized_name` from business_sale_report (observed, confidence 1.0): business services
...
- `source_key` from business_sale_report (observed, confidence 1.0): e7df5102a2dc8b10
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/business-services-professional-and-financial-ireland-679414
- `summary` from business_sale_report (observed, confidence 1.0): This thriving business services company in Dublin has carved out a niche with key clients in the high-growth blockchain and payments sectors, boasting impressive margins. Business Sale Report public listing observed 2026-06-25.
