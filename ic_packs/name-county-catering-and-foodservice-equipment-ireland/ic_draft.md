# IC Draft: Catering and Foodservice Equipment

**Diligence status:** watchlist

## Company Overview

- Name: Catering and Foodservice Equipment
...
- `name` from business_sale_report (observed, confidence 1.0): Catering and Foodservice Equipment
- `normalized_name` from business_sale_report (observed, confidence 1.0): catering and foodservice equipment
...
- `source_key` from business_sale_report (observed, confidence 1.0): 185c3d26ecbb609c
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/catering-and-foodservice-equipment-retail-ireland-679938
- `summary` from business_sale_report (observed, confidence 1.0): This is a rare opportunity to acquire a market-leading catering and food equipment business in Cork with a well-established reputation for quality and customer service. Business Sale Report public listing observed 2026-06-24.
