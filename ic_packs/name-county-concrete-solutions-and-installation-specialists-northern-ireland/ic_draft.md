# IC Draft: Concrete Solutions and Installation Specialists

**Diligence status:** enrichment_required

## Company Overview

- Name: Concrete Solutions and Installation Specialists
...
- `name` from business_sale_report (observed, confidence 1.0): Concrete Solutions and Installation Specialists
- `normalized_name` from business_sale_report (observed, confidence 1.0): concrete solutions and installation specialists
