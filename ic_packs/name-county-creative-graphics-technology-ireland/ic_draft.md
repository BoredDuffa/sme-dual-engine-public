# IC Draft: Creative Graphics Technology

**Diligence status:** watchlist

## Company Overview

- Name: Creative Graphics Technology
...
- `name` from business_sale_report (observed, confidence 1.0): Creative Graphics Technology
- `normalized_name` from business_sale_report (observed, confidence 1.0): creative graphics technology
