# IC Draft: Dental and Aesthetic Clinic

**Diligence status:** enrichment_required

## Company Overview

- Name: Dental and Aesthetic Clinic
...
- `name` from business_sale_report (observed, confidence 1.0): Dental and Aesthetic Clinic
- `normalized_name` from business_sale_report (observed, confidence 1.0): dental and aesthetic clinic
...
- `source_key` from business_sale_report (observed, confidence 1.0): 8719b3f08a819fe5
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/dental-and-aesthetic-clinic-medical-ireland-680155
- `summary` from business_sale_report (observed, confidence 1.0): This well-established dental and aesthetic clinic in Dublin offers a comprehensive range of services from general dentistry to non-invasive facial treatments, and is known for its welcoming environment and loyal patient base. Business Sale Report public listing observed 2026-06-24.
