# IC Draft: Distributor of Medical Equipment and Technology

**Diligence status:** watchlist

## Company Overview

- Name: Distributor of Medical Equipment and Technology
...
- `name` from business_sale_report (observed, confidence 1.0): Distributor of Medical Equipment and Technology
- `normalized_name` from business_sale_report (observed, confidence 1.0): distributor of medical equipment and technology
