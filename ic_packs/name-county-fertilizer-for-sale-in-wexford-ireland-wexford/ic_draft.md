# IC Draft: Fertilizer Company for Sale in Wexford, Ireland

**Diligence status:** enrichment_required

## Company Overview

- Name: Fertilizer Company for Sale in Wexford, Ireland
- Location: Wexford, County Wexford, Ireland, Wexford
...
- Macro score: 97.0
- Matched sectors: healthcare, manufacturing, agri
...
- `name` from smergers (observed, confidence 1.0): Fertilizer Company for Sale in Wexford, Ireland
- `normalized_name` from smergers (observed, confidence 1.0): fertilizer for sale in wexford ireland
- `price_text` from smergers (observed, confidence 1.0): EUR 200 K
- `price_value` from smergers (observed, confidence 1.0): 200000.0
