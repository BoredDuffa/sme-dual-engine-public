# IC Draft: Fibreboard Packaging and Print Solutions

**Diligence status:** watchlist

## Company Overview

- Name: Fibreboard Packaging and Print Solutions
...
- `name` from business_sale_report (observed, confidence 1.0): Fibreboard Packaging and Print Solutions
- `normalized_name` from business_sale_report (observed, confidence 1.0): fibreboard packaging and print solutions
...
- `source_key` from business_sale_report (observed, confidence 1.0): 0b2ca4b840e54d03
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/fibreboard-packaging-and-print-solutions-manufacturing-ireland-680152
- `summary` from business_sale_report (observed, confidence 1.0): This well-established manufacturer of fibreboard packaging and commercial print in Ireland operates from a fully integrated facility, offering a diverse portfolio of packaging and printing solutions backed by a skilled workforce. Business Sale Report public listing observed 2026-06-24.
