# IC Draft: Financial Advisory AR

**Diligence status:** enrichment_required

## Company Overview

- Name: Financial Advisory AR
...
- `evidence_text` from business_sale_report (observed, confidence 1.0): public advertised-for-sale listing £1,350,000 Business Sale Report public listing observed 2026-06-24.
...
- `name` from business_sale_report (observed, confidence 1.0): Financial Advisory AR
- `normalized_name` from business_sale_report (observed, confidence 1.0): financial advisory ar
- `price_text` from business_sale_report (observed, confidence 1.0): £1,350,000
...
- `summary` from business_sale_report (observed, confidence 1.0): Opportunity to acquire a well-established local IFA firm in the vibrant city of Belfast, providing potential for growth in a dynamic financial services market. Business Sale Report public listing observed 2026-06-24.
