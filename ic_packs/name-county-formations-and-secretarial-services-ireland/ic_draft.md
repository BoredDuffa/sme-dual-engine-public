# IC Draft: Company Formations and Secretarial Services

**Diligence status:** watchlist

## Company Overview

- Name: Company Formations and Secretarial Services
...
- `name` from business_sale_report (observed, confidence 1.0): Company Formations and Secretarial Services
- `normalized_name` from business_sale_report (observed, confidence 1.0): formations and secretarial services
...
- `source_key` from business_sale_report (observed, confidence 1.0): 474f48ce0a73446c
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/company-formations-and-secretarial-services-professional-and-financial-ireland-680434
- `summary` from business_sale_report (observed, confidence 1.0): This is a rare opportunity to acquire a leading corporate services provider with over 30 years of expertise, renowned for its comprehensive suite of offerings and strong recurring revenue. Business Sale Report public listing observed 2026-06-25.
