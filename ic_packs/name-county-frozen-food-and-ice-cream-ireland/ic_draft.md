# IC Draft: Frozen Food and Ice Cream

**Diligence status:** watchlist

## Company Overview

- Name: Frozen Food and Ice Cream
...
- `name` from business_sale_report (observed, confidence 1.0): Frozen Food and Ice Cream
- `normalized_name` from business_sale_report (observed, confidence 1.0): frozen food and ice cream
...
- `source_key` from business_sale_report (observed, confidence 1.0): 08b31fb32144d98b
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/frozen-food-and-ice-cream-wholesale-ireland-680072
- `summary` from business_sale_report (observed, confidence 1.0): An established distributor of ice cream and frozen food products in Ireland is available for acquisition, offering a substantial customer base and strong official distributor status with top-tier suppliers. Business Sale Report public listing observed 2026-06-24.
