# IC Draft: Gas Heating Service Provider

**Diligence status:** watchlist

## Company Overview

- Name: Gas Heating Service Provider
...
- `name` from business_sale_report (observed, confidence 1.0): Gas Heating Service Provider
- `normalized_name` from business_sale_report (observed, confidence 1.0): gas heating service provider
...
- `source_key` from business_sale_report (observed, confidence 1.0): ed084316c029421d
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/gas-heating-service-provider-services-ireland-680235
- `summary` from business_sale_report (observed, confidence 1.0): This well-established gas heating servicing and repair company in Dublin boasts a robust database of repeat and account customers, reflecting its robust market position. Business Sale Report public listing observed 2026-06-24.
