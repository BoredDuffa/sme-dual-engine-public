# IC Draft: Hair Restoration Clinic
...
- `name` from business_sale_report (observed, confidence 1.0): Hair Restoration Clinic
- `normalized_name` from business_sale_report (observed, confidence 1.0): hair restoration clinic
...
- `source_key` from business_sale_report (observed, confidence 1.0): 5fe4001992f7e786
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/hair-restoration-clinic-medical-ireland-679681
- `summary` from business_sale_report (observed, confidence 1.0): This well-established hair restoration business in Ireland boasts a large client base and is strategically positioned for expansion, with significant potential for growth across the country. Business Sale Report public listing observed 2026-06-24.
