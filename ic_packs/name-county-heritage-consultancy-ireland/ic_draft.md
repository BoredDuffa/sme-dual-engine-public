# IC Draft: Heritage Consultancy

**Diligence status:** watchlist

## Company Overview

- Name: Heritage Consultancy
...
- `name` from business_sale_report (observed, confidence 1.0): Heritage Consultancy
- `normalized_name` from business_sale_report (observed, confidence 1.0): heritage consultancy
...
- `source_key` from business_sale_report (observed, confidence 1.0): 51a20b63b1f58be1
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/heritage-consultancy-professional-and-financial-ireland-679937
- `summary` from business_sale_report (observed, confidence 1.0): This well-established heritage consultancy in Munster offers a unique opportunity to enter or expand within the growing field of heritage consultancy in Ireland, with demand currently outpacing the capacity of the existing team. Business Sale Report public listing observed 2026-06-24.
