# IC Draft: Highly-Regarded Building and Civil Engineering

**Diligence status:** enrichment_required

## Company Overview

- Name: Highly-Regarded Building and Civil Engineering
...
- `name` from business_sale_report (observed, confidence 1.0): Highly-Regarded Building and Civil Engineering
- `normalized_name` from business_sale_report (observed, confidence 1.0): highly regarded building and civil engineering
...
- `source_key` from business_sale_report (observed, confidence 1.0): f47f3371de91c200
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/highly-regarded-building-and-civil-engineering-building-and-construction-ireland-680464
- `summary` from business_sale_report (observed, confidence 1.0): The company is a long-established building and civil engineering company, specialising in the provision of industrial, commercial and residential property construction services. Business Sale Report public listing observed 2026-06-25.
