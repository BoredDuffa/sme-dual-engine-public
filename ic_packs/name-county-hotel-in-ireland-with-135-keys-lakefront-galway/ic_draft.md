# IC Draft: Hotel In Ireland With 135 Keys & Lakefront

**Diligence status:** defer

## Company Overview

- Name: Hotel In Ireland With 135 Keys & Lakefront
- Location: Galway, Galway, Ireland, Galway
- Sector: Hospitality & Tourism
- Company status: unknown
- Company age: unknown
- Origination score: 44.5
...
- `evidence_text` from businessesforsale_ie (observed, confidence 1.0): public advertised-for-sale listing EUR 8500000 BusinessesForSale.ie JSON-LD listing observed 2026-06-26.
...
- `name` from businessesforsale_ie (observed, confidence 1.0): Hotel In Ireland With 135 Keys & Lakefront
- `normalized_name` from businessesforsale_ie (observed, confidence 1.0): hotel in ireland with 135 keys & lakefront
- `price_text` from businessesforsale_ie (observed, confidence 1.0): €8,500,000
- `price_value` from businessesforsale_ie (observed, confidence 1.0): 8500000.0
...
- `source_key` from businessesforsale_ie (observed, confidence 1.0): hotel-in-ireland-with-135-keys-and-lakefront
- `source_section` from businessesforsale_ie (observed, confidence 1.0): brokered_targets
- `source_url` from businessesforsale_ie (observed, confidence 1.0): https://www.businessesforsale.ie/irish/hotel-in-ireland-with-135-keys-and-lakefront.aspx
