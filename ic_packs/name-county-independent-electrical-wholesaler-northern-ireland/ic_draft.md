# IC Draft: Independent Electrical Wholesaler

**Diligence status:** watchlist

## Company Overview

- Name: Independent Electrical Wholesaler
- Location: Northern Ireland, UK, Northern Ireland
- Sector: Food & Agribusiness
- Company status: unknown
- Company age: unknown
- Origination score: 56.6
...
- `name` from business_sale_report (observed, confidence 1.0): Independent Electrical Wholesaler
- `normalized_name` from business_sale_report (observed, confidence 1.0): independent electrical wholesaler
...
- `source_key` from business_sale_report (observed, confidence 1.0): fd9ed4beb672d7d6
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/independent-electrical-wholesaler-wholesale-northern-ireland-675939
- `summary` from business_sale_report (observed, confidence 1.0): The company is an independently owned electrical wholesaler, specialising in the supply of industrial electrical parts, components, and consumables. Business Sale Report public listing observed 2026-06-24.
