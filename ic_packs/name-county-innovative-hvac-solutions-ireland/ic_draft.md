# IC Draft: Innovative HVAC Solutions

**Diligence status:** enrichment_required

## Company Overview

- Name: Innovative HVAC Solutions
...
- Macro score: 97.0
- Matched sectors: hvac, logistics, manufacturing
...
- `name` from business_sale_report (observed, confidence 1.0): Innovative HVAC Solutions
- `normalized_name` from business_sale_report (observed, confidence 1.0): innovative hvac solutions
...
- `source_key` from business_sale_report (observed, confidence 1.0): 56e9860c9b950e18
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/innovative-hvac-solutions-engineering-ireland-679668
- `summary` from business_sale_report (observed, confidence 1.0): This established HVAC company in Dublin offers a comprehensive range of climate-control solutions, bolstered by a proprietary air sterilisation technology that sets it apart in the market. Business Sale Report public listing observed 2026-06-25.
