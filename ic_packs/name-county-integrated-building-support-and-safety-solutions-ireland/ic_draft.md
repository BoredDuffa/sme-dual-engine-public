# IC Draft: Integrated Building Support and Safety Solutions

**Diligence status:** enrichment_required

## Company Overview

- Name: Integrated Building Support and Safety Solutions
...
- `name` from business_sale_report (observed, confidence 1.0): Integrated Building Support and Safety Solutions
- `normalized_name` from business_sale_report (observed, confidence 1.0): integrated building support and safety solutions
...
- `source_key` from business_sale_report (observed, confidence 1.0): ca0aa82df336454b
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/integrated-building-support-and-safety-solutions-services-ireland-680459
- `summary` from business_sale_report (observed, confidence 1.0): This well-established Irish company stands out as a leading provider of fire protection and security systems, boasting a remarkable client retention rate of nearly 100% across its 450 active clients. Business Sale Report public listing observed 2026-06-24.
