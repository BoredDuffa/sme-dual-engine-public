# IC Draft: Manufacturer and Importer of School Furniture

**Diligence status:** watchlist

## Company Overview

- Name: Manufacturer and Importer of School Furniture
- Location: Ireland, UK, Ireland
- Sector: Retail & Consumer
- Company status: unknown
- Company age: unknown
- Origination score: 50.0
...
- `name` from business_sale_report (observed, confidence 1.0): Manufacturer and Importer of School Furniture
- `normalized_name` from business_sale_report (observed, confidence 1.0): manufacturer and importer of school furniture
...
- `source_key` from business_sale_report (observed, confidence 1.0): 484d3a0ea8165118
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/manufacturer-and-importer-of-school-furniture-manufacturing-ireland-680389
- `summary` from business_sale_report (observed, confidence 1.0): The company manufactures and imports school furniture for primary schools, secondary schools, and playschools, also supplying building projects. Business Sale Report public listing observed 2026-06-25.
