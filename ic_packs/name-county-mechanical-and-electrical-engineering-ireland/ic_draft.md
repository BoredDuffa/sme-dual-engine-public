# IC Draft: Mechanical and Electrical Engineering
...
- `name` from business_sale_report (observed, confidence 1.0): Mechanical and Electrical Engineering
- `normalized_name` from business_sale_report (observed, confidence 1.0): mechanical and electrical engineering
...
- `source_key` from business_sale_report (observed, confidence 1.0): 36db2dcf7f76c9e6
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/mechanical-and-electrical-engineering-engineering-ireland-679633
- `summary` from business_sale_report (observed, confidence 1.0): This well-established engineering consultancy, with a strong presence in the west of Ireland, offers a robust regional presence and a diversified project portfolio across both public and private sectors. Business Sale Report public listing observed 2026-06-24.
