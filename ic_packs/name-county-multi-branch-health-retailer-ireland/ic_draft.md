# IC Draft: Multi-Branch Health Retailer

**Diligence status:** watchlist

## Company Overview

- Name: Multi-Branch Health Retailer
...
- `name` from business_sale_report (observed, confidence 1.0): Multi-Branch Health Retailer
- `normalized_name` from business_sale_report (observed, confidence 1.0): multi branch health retailer
...
- `source_key` from business_sale_report (observed, confidence 1.0): a01c79b4386aa1de
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/multi-branch-health-retailer-retail-ireland-679954
- `summary` from business_sale_report (observed, confidence 1.0): This is an opportunity to acquire a reputable multi-branch retail health business, well-positioned in Dublin and surrounding regional locations. Business Sale Report public listing observed 2026-06-24.
