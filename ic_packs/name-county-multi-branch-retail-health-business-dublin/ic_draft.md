# IC Draft: Multi-Branch Retail Health Business

**Diligence status:** watchlist

## Company Overview

- Name: Multi-Branch Retail Health Business
...
- `evidence_text` from businessesforsale_ie (observed, confidence 1.0): public advertised-for-sale listing EUR 1250000 BusinessesForSale.ie JSON-LD listing observed 2026-06-25.
...
- `name` from businessesforsale_ie (observed, confidence 1.0): Multi-Branch Retail Health Business
- `normalized_name` from businessesforsale_ie (observed, confidence 1.0): multi branch retail health business
- `price_text` from businessesforsale_ie (observed, confidence 1.0): EUR 1250000
- `price_value` from businessesforsale_ie (observed, confidence 1.0): 1250000.0
...
- `source_key` from businessesforsale_ie (observed, confidence 1.0): 3a82472f9c39f230
- `source_section` from businessesforsale_ie (observed, confidence 1.0): advertised_sale_listings
- `source_url` from businessesforsale_ie (observed, confidence 1.0): https://www.businessesforsale.ie/irish/multi-branch-retail-health-business.aspx
- `summary` from businessesforsale_ie (observed, confidence 1.0): Deal Chasers are proud to offer for sale this well-established health business with several regional branches with scope modernisation and standardisation. BusinessesForSale.ie JSON-LD listing observed 2026-06-25.
