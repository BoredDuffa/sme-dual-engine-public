# IC Draft: Nationwide Agricultural Equipment

**Diligence status:** enrichment_required

## Company Overview

- Name: Nationwide Agricultural Equipment
...
- `name` from business_sale_report (observed, confidence 1.0): Nationwide Agricultural Equipment
- `normalized_name` from business_sale_report (observed, confidence 1.0): nationwide agricultural equipment
