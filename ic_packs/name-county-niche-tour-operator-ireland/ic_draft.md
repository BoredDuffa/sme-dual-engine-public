# IC Draft: Niche Tour Operator

**Diligence status:** watchlist

## Company Overview

- Name: Niche Tour Operator
...
- `name` from business_sale_report (observed, confidence 1.0): Niche Tour Operator
- `normalized_name` from business_sale_report (observed, confidence 1.0): niche tour operator
...
- `source_key` from business_sale_report (observed, confidence 1.0): 7357d65c13eb6e09
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/niche-tour-operator-leisure-and-lifestyle-ireland-679339
- `summary` from business_sale_report (observed, confidence 1.0): This well-established business, based in Ireland, excels in organizing inbound tour packages for international performing arts groups and outbound sports tours to major UK events. Business Sale Report public listing observed 2026-06-24.
