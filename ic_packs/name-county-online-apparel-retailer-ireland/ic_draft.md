# IC Draft: Online Apparel Retailer

**Diligence status:** watchlist

## Company Overview

- Name: Online Apparel Retailer
...
- `name` from business_sale_report (observed, confidence 1.0): Online Apparel Retailer
- `normalized_name` from business_sale_report (observed, confidence 1.0): online apparel retailer
...
- `source_key` from business_sale_report (observed, confidence 1.0): 585869f1b4dfd749
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/online-apparel-retailer-online-businesses-ireland-679423
- `summary` from business_sale_report (observed, confidence 1.0): This is a rare opportunity to acquire a well-established e-commerce fashion retailer based in Dublin, renowned for its strong customer loyalty and stylish everyday women's apparel. Business Sale Report public listing observed 2026-06-24.
