# IC Draft: Plant and Machinery Leasing

**Diligence status:** enrichment_required

## Company Overview

- Name: Plant and Machinery Leasing
...
- Macro score: 97.0
- Matched sectors: logistics, manufacturing, agri
...
- `evidence_text` from business_sale_report (observed, confidence 1.0): public advertised-for-sale listing £5,364,000 Business Sale Report public listing observed 2026-06-24.
...
- `name` from business_sale_report (observed, confidence 1.0): Plant and Machinery Leasing
- `normalized_name` from business_sale_report (observed, confidence 1.0): plant and machinery leasing
- `price_text` from business_sale_report (observed, confidence 1.0): £5,364,000
...
- `source_key` from business_sale_report (observed, confidence 1.0): 02235fcae20c1fe5
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/plant-and-machinery-leasing-services-ireland-679542
- `summary` from business_sale_report (observed, confidence 1.0): Opportunity to acquire a long-established plant and agricultural machinery business in the West of Ireland, renowned for its strong regional reputation and brand loyalty. Business Sale Report public listing observed 2026-06-24.
