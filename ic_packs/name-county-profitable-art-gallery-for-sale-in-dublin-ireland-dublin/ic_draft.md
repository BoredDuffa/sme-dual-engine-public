# IC Draft: Profitable Art Gallery for Sale in Dublin, Ireland

**Diligence status:** enrichment_required

## Company Overview

- Name: Profitable Art Gallery for Sale in Dublin, Ireland
...
- `name` from smergers (observed, confidence 1.0): Profitable Art Gallery for Sale in Dublin, Ireland
- `normalized_name` from smergers (observed, confidence 1.0): profitable art gallery for sale in dublin ireland
- `price_text` from smergers (observed, confidence 1.0): EUR 10 K
- `price_value` from smergers (observed, confidence 1.0): 10000.0
