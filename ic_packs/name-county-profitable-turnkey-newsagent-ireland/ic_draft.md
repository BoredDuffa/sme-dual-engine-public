# IC Draft: Profitable Turnkey Newsagent

**Diligence status:** watchlist

## Company Overview

- Name: Profitable Turnkey Newsagent
...
- `name` from business_sale_report (observed, confidence 1.0): Profitable Turnkey Newsagent
- `normalized_name` from business_sale_report (observed, confidence 1.0): profitable turnkey newsagent
...
- `source_key` from business_sale_report (observed, confidence 1.0): 46de24fc9c14b552
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/profitable-turnkey-newsagent-retail-ireland-679990
- `summary` from business_sale_report (observed, confidence 1.0): This is a rare chance to acquire a well-established and consistently profitable newsagent located in a prime spot in an affluent South Dublin town. Business Sale Report public listing observed 2026-06-24.
