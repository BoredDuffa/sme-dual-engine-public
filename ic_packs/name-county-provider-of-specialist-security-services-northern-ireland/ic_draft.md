# IC Draft: Provider of Specialist Security Services

**Diligence status:** watchlist

## Company Overview

- Name: Provider of Specialist Security Services
...
- `name` from business_sale_report (observed, confidence 1.0): Provider of Specialist Security Services
- `normalized_name` from business_sale_report (observed, confidence 1.0): provider of specialist security services
...
- `source_key` from business_sale_report (observed, confidence 1.0): 2b2c2a64fa14ef04
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/provider-of-specialist-security-services-services-northern-ireland-679792
- `summary` from business_sale_report (observed, confidence 1.0): The business’s services encompass manned guarding, CCTV monitoring, vehicle patrol, key holding, event security, and door supervision, all delivered by highly qualified security personnel. Business Sale Report public listing observed 2026-06-25.
