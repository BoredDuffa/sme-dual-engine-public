# IC Draft: Pub and Restaurant for Lease

**Diligence status:** watchlist

## Company Overview

- Name: Pub and Restaurant for Lease
...
- `name` from business_sale_report (observed, confidence 1.0): Pub and Restaurant for Lease
- `normalized_name` from business_sale_report (observed, confidence 1.0): pub and restaurant for lease
...
- `source_key` from business_sale_report (observed, confidence 1.0): 99d7cd24663cbf0b
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/pub-and-restaurant-for-lease-cafes-restaurants-pubs-ireland-679955
- `summary` from business_sale_report (observed, confidence 1.0): This well-established pub and restaurant in Dublin offers a rare opportunity with a strong turnover and included valuable fixtures and inventory. Business Sale Report public listing observed 2026-06-25.
