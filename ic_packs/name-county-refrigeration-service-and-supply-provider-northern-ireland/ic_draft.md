# IC Draft: Refrigeration Service and Supply Provider

**Diligence status:** enrichment_required

## Company Overview

- Name: Refrigeration Service and Supply Provider
- Location: Northern Ireland, Northern Ireland, UK, Northern Ireland
...
- `evidence_text` from business_sale_report (observed, confidence 1.0): public advertised-for-sale listing £295,000 Business Sale Report public listing observed 2026-06-24.
...
- `name` from business_sale_report (observed, confidence 1.0): Refrigeration Service and Supply Provider
- `normalized_name` from business_sale_report (observed, confidence 1.0): refrigeration service and supply provider
- `price_text` from business_sale_report (observed, confidence 1.0): £295,000
...
- `source_key` from business_sale_report (observed, confidence 1.0): 893a2d0547e043d6
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/refrigeration-service-and-supply-provider-retail-northern-ireland-670696
- `summary` from business_sale_report (observed, confidence 1.0): This family-run business, established in 2003, presents a prime opportunity for expansion through increased geographical coverage and enhanced marketing efforts. Located in a secure, modern business park, it boasts a solid reputation and established... Business Sale Report public listing observed 2026-06-24.
