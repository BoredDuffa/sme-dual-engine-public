# IC Draft: Restaurant and Coffee House

**Diligence status:** watchlist

## Company Overview

- Name: Restaurant and Coffee House
...
- `name` from business_sale_report (observed, confidence 1.0): Restaurant and Coffee House
- `normalized_name` from business_sale_report (observed, confidence 1.0): restaurant and coffee house
...
- `source_key` from business_sale_report (observed, confidence 1.0): 7f676996d1366b4e
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/restaurant-and-coffee-house-cafes-restaurants-pubs-ireland-679966
- `summary` from business_sale_report (observed, confidence 1.0): Situated in a prime South Dublin location, this exceptional restaurant and coffee house has become a local favourite over its sixteen-year history, known for its quality offerings and welcoming atmosphere. Business Sale Report public listing observed 2026-06-24.
