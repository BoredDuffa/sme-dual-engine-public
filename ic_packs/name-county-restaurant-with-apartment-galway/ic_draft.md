# IC Draft: Restaurant with Apartment

**Diligence status:** watchlist

## Company Overview

- Name: Restaurant with Apartment
- Location: Galway, Ireland, IR, Galway
...
- `county` from business_sale_report (observed, confidence 1.0): Galway
...
- `name` from business_sale_report (observed, confidence 1.0): Restaurant with Apartment
- `normalized_name` from business_sale_report (observed, confidence 1.0): restaurant with apartment
...
- `source_key` from business_sale_report (observed, confidence 1.0): 03d54129c4f275b5
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/restaurant-with-apartment-cafes-restaurants-pubs-ireland-680065
- `summary` from business_sale_report (observed, confidence 1.0): This well-established pizzeria restaurant in the heart of Galway city offers an ideal turnkey opportunity for an owner-operator or hospitality group. Business Sale Report public listing observed 2026-06-24.
- `town` from business_sale_report (observed, confidence 1.0): Galway, Ireland, IR
