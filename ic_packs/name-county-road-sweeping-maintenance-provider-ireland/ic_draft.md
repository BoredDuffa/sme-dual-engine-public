# IC Draft: Road Sweeping & Maintenance Provider

**Diligence status:** watchlist

## Company Overview

- Name: Road Sweeping & Maintenance Provider
...
- `name` from business_sale_report (observed, confidence 1.0): Road Sweeping & Maintenance Provider
- `normalized_name` from business_sale_report (observed, confidence 1.0): road sweeping & maintenance provider
...
- `source_key` from business_sale_report (observed, confidence 1.0): 377f2f11c3c5612a
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/road-sweeping-maintenance-provider-services-ireland-680076
- `summary` from business_sale_report (observed, confidence 1.0): This is a unique opportunity to acquire a road sweeping and maintenance company with a robust order book and a growing fleet, including road sweepers and additional support vehicles. Business Sale Report public listing observed 2026-06-25.
