# IC Draft: Salad Production Enterprise

**Diligence status:** watchlist

## Company Overview

- Name: Salad Production Enterprise
- Location: Ireland, IR, Ireland
- Sector: Business Services
- Company status: unknown
- Company age: unknown
- Origination score: 53.4
...
- `name` from business_sale_report (observed, confidence 1.0): Salad Production Enterprise
- `normalized_name` from business_sale_report (observed, confidence 1.0): salad production enterprise
...
- `source_key` from business_sale_report (observed, confidence 1.0): 74c06f192599479a
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/salad-production-enterprise-manufacturing-ireland-679936
- `summary` from business_sale_report (observed, confidence 1.0): An award-winning fresh salad producer in Wexford is on the market, offering a strong, established brand with an accredited production facility. Business Sale Report public listing observed 2026-06-25.
