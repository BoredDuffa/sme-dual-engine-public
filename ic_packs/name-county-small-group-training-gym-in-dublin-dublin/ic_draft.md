# IC Draft: Small Group Training Gym In Dublin

**Diligence status:** watchlist

## Company Overview

- Name: Small Group Training Gym In Dublin
- Location: East Wall, Dublin, Ireland, Dublin
...
- `name` from businessesforsale_ie (observed, confidence 1.0): Small Group Training Gym In Dublin
- `normalized_name` from businessesforsale_ie (observed, confidence 1.0): small group training gym in dublin
