# IC Draft: Specialist Chemical-Resistant Flooring Provider

**Diligence status:** watchlist

## Company Overview

- Name: Specialist Chemical-Resistant Flooring Provider
...
- `name` from business_sale_report (observed, confidence 1.0): Specialist Chemical-Resistant Flooring Provider
- `normalized_name` from business_sale_report (observed, confidence 1.0): specialist chemical resistant flooring provider
