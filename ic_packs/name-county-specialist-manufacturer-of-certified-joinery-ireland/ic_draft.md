# IC Draft: Specialist Manufacturer of Certified Joinery

**Diligence status:** enrichment_required

## Company Overview

- Name: Specialist Manufacturer of Certified Joinery
...
- `name` from business_sale_report (observed, confidence 1.0): Specialist Manufacturer of Certified Joinery
- `normalized_name` from business_sale_report (observed, confidence 1.0): specialist manufacturer of certified joinery
...
- `source_key` from business_sale_report (observed, confidence 1.0): 7f08027c600d0d3b
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/specialist-manufacturer-of-certified-joinery-manufacturing-ireland-679603
- `summary` from business_sale_report (observed, confidence 1.0): This specialist manufacturing business offers a significant opportunity with its established reputation in producing certified fire doors and bespoke joinery products, backed by a modern and scalable production facility. Business Sale Report public listing observed 2026-06-24.
