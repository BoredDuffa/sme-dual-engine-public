# IC Draft: SQUAT Dental Practice

**Diligence status:** enrichment_required

## Company Overview

- Name: SQUAT Dental Practice
...
- `name` from business_sale_report (observed, confidence 1.0): SQUAT Dental Practice
- `normalized_name` from business_sale_report (observed, confidence 1.0): squat dental practice
...
- `source_key` from business_sale_report (observed, confidence 1.0): b7fd507909de0ada
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/squat-dental-practice-medical-northern-ireland-668186
- `summary` from business_sale_report (observed, confidence 1.0): This is a fantastic opportunity to invest in a newly established dental practice in Northern Ireland. Business Sale Report public listing observed 2026-06-25.
