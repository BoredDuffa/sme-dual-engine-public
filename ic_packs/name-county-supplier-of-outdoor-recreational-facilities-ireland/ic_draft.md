# IC Draft: Supplier of Outdoor Recreational Facilities

**Diligence status:** watchlist

## Company Overview

- Name: Supplier of Outdoor Recreational Facilities
- Location: Ireland, UK, Ireland
- Sector: Business Services
- Company status: unknown
- Company age: unknown
- Origination score: 54.1
...
- `name` from business_sale_report (observed, confidence 1.0): Supplier of Outdoor Recreational Facilities
- `normalized_name` from business_sale_report (observed, confidence 1.0): supplier of outdoor recreational facilities
...
- `source_key` from business_sale_report (observed, confidence 1.0): 43cf85948ec3c9cb
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/supplier-of-outdoor-recreational-facilities-retail-ireland-680418
- `summary` from business_sale_report (observed, confidence 1.0): The company designs, supplies, installs, and maintains a comprehensive range of outdoor fitness and recreation facilities, with a specialisation in outdoor gym equipment. Business Sale Report public listing observed 2026-06-25.
