# IC Draft: Temporary Event Flooring Specialist

**Diligence status:** watchlist

## Company Overview

- Name: Temporary Event Flooring Specialist
- Location: Ireland, IR, Ireland
- Sector: Business Services
- Company status: unknown
- Company age: unknown
- Origination score: 51.2
...
- `name` from business_sale_report (observed, confidence 1.0): Temporary Event Flooring Specialist
- `normalized_name` from business_sale_report (observed, confidence 1.0): temporary event flooring specialist
...
- `source_key` from business_sale_report (observed, confidence 1.0): adf3c96066a364c2
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/temporary-event-flooring-specialist-services-ireland-680074
- `summary` from business_sale_report (observed, confidence 1.0): A leading provider of temporary event flooring solutions in Ireland is up for sale, offering renowned precision and exceptional service to major event organisers nationwide. Business Sale Report public listing observed 2026-06-24.
