# IC Draft: Turnkey Gym In Prime Location In Dublin

**Diligence status:** defer

## Company Overview

- Name: Turnkey Gym In Prime Location In Dublin
- Location: Dublin, Ireland, Dublin
- Sector: Business Services
- Company status: unknown
- Company age: unknown
- Origination score: 43.6
...
- `evidence_text` from businessesforsale_ie (observed, confidence 1.0): public advertised-for-sale listing EUR 200000 BusinessesForSale.ie JSON-LD listing observed 2026-06-26.
...
- `name` from businessesforsale_ie (observed, confidence 1.0): Turnkey Gym In Prime Location In Dublin
- `normalized_name` from businessesforsale_ie (observed, confidence 1.0): turnkey gym in prime location in dublin
- `price_text` from businessesforsale_ie (observed, confidence 1.0): EUR 200000
- `price_value` from businessesforsale_ie (observed, confidence 1.0): 200000.0
...
- `source_key` from businessesforsale_ie (observed, confidence 1.0): 7f3bb3fddaa46559
- `source_section` from businessesforsale_ie (observed, confidence 1.0): advertised_sale_listings
- `source_url` from businessesforsale_ie (observed, confidence 1.0): https://www.businessesforsale.ie/irish/turnkey-gym-in-prime-location-in-dublin.aspx
- `summary` from businessesforsale_ie (observed, confidence 1.0): This fully equipped, long-standing fitness business has built a loyal community and maintains over 130 active members on recurring subscriptions. Known for its expert coaching and inclusive atmosphere... BusinessesForSale.ie JSON-LD listing observed 2026-06-26.
