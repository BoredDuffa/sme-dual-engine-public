# IC Draft: Two-Way Communication Technology Distributor

**Diligence status:** enrichment_required

## Company Overview

- Name: Two-Way Communication Technology Distributor
...
- `name` from business_sale_report (observed, confidence 1.0): Two-Way Communication Technology Distributor
- `normalized_name` from business_sale_report (observed, confidence 1.0): two way communication technology distributor
...
- `source_key` from business_sale_report (observed, confidence 1.0): f6c03f54b1778829
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/two-way-communication-technology-distributor-technology-northern-ireland-678989
- `summary` from business_sale_report (observed, confidence 1.0): This well-established business in Northern Ireland specialises in professional two-way radio systems and services, enjoying a high client retention rate with 80% of sales from existing clients and an impressive 80% tender success rate. Servicing over... Business Sale Report public listing observed 2026-06-24.
