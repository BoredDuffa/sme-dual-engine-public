# IC Draft: Tyre Service and Automotive Experts

**Diligence status:** watchlist

## Company Overview

- Name: Tyre Service and Automotive Experts
...
- `name` from business_sale_report (observed, confidence 1.0): Tyre Service and Automotive Experts
- `normalized_name` from business_sale_report (observed, confidence 1.0): tyre service and automotive experts
...
- `source_key` from business_sale_report (observed, confidence 1.0): 88cc2c8742f94077
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/tyre-service-and-automotive-experts-services-ireland-680208
- `summary` from business_sale_report (observed, confidence 1.0): This established tyre shop in Dundrum boasts a loyal customer base and a reputation for quality service, offering a consistent revenue stream and solid supplier relationships. Business Sale Report public listing observed 2026-06-24.
