# IC Draft: Wholesale Food Business

**Diligence status:** watchlist

## Company Overview

- Name: Wholesale Food Business
...
- `name` from business_sale_report (observed, confidence 1.0): Wholesale Food Business
- `normalized_name` from business_sale_report (observed, confidence 1.0): wholesale food business
...
- `source_key` from business_sale_report (observed, confidence 1.0): 97cf7b584f8e968a
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/wholesale-food-business-wholesale-ireland-680385
- `summary` from business_sale_report (observed, confidence 1.0): This is a lucrative opportunity to acquire a long-established wholesale snack food business with a strong brand presence, supplying major supermarkets and grocery stores across Ireland. Business Sale Report public listing observed 2026-06-25.
