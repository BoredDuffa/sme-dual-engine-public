# IC Draft: Wholesale Food Supply Specialist

**Diligence status:** watchlist

## Company Overview

- Name: Wholesale Food Supply Specialist
- Location: Northern Ireland, UK, Northern Ireland
- Sector: Food & Agribusiness
- Company status: unknown
- Company age: unknown
- Origination score: 57.3
...
- `name` from business_sale_report (observed, confidence 1.0): Wholesale Food Supply Specialist
- `normalized_name` from business_sale_report (observed, confidence 1.0): wholesale food supply specialist
...
- `source_key` from business_sale_report (observed, confidence 1.0): 857f99e562644dea
- `source_section` from business_sale_report (observed, confidence 1.0): advertised_sale_listings
- `source_url` from business_sale_report (observed, confidence 1.0): https://www.business-sale.com/companies-for-sale/wholesale-food-supply-specialist-wholesale-northern-ireland-671643
- `summary` from business_sale_report (observed, confidence 1.0): This well-established wholesale supplier of frozen, chilled, and ambient food, along with recyclable packaging, boasts a strong reputation and a loyal customer base of over 400 repeat clients, some relationships extending 25 years. The robust second-... Business Sale Report public listing observed 2026-06-24.
